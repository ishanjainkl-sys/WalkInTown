...
const TermsAndConditionVendorDetailsDialog = ({ isChecked, setIsChecked }) => {
  return (
    <Dialog>
      ...
      />
      <DialogTrigger>
        <div className=" -translate-y-1 pl-2 flex items-center gap-2">
          <p className=" text-gray-600 text-sm">
            Terms and Conditions<span className=" text-primary-red">*</span>
          </p>
          <Info size={18} />
        </div>
      </DialogTrigger>
      <DialogContent
        ...
        className="max-w-5xl overflow-y-auto w-full"
      >
        <DialogHeader
          className={
        ...
        >
          ...
          <div className=" flex flex-col gap-3">
            <p className=" text-3xl font-semibold text-primary-red">
              Terms and Conditions
            </p>
            <p className=" font-semibold text-lg">Your Agreement</p>
            <p className="max-h-[40vh] md:max-h-[65vh] overflow-y-auto">
              Welcome to WalkIn Town! By registering as a retailer and using our
              platform to showcase your store offers to customers, you agree to
              comply with the following terms and conditions. Please read these
              ...
              1. Eligibility
              <br></br>
              1.1 You must be a legally registered business to use our platform
              as a retailer. 1.2 By registering, you represent and warrant that
              ...
              your account credentials. 2.2 Any activity conducted under your
              account is your responsibility. Notify us immediately of
              unauthorized access or breaches. 2.3 The platform reserves the
              right to suspend or terminate accounts that violate these terms.
              <br></br>
              3. Retailer Responsibilities
              <br></br>
              3.1 You agree to provide accurate and lawful information about
              your store and offers. 3.2 All offers must comply with applicable
              laws, including but not limited to consumer protection laws,
              advertising standards, and anti-fraud regulations. 3.3 You must
              not post misleading, false, or inappropriate content on the
              platform. 3.4 You are solely responsible for fulfilling the offers
              you advertise and resolving customer complaints related to them.
              <br></br>
              ...
              SOLELY RESPONSIBLE FOR ANY DAMAGE TO YOUR COMPUTER SYSTEM OR FOR
              ...
              generator.lorem-ipsum.info 126 Electricov St.
              <br></br>
              Kiev, Kiev 04176
              <br></br>
              Ukraine
              ...
              office in Kiev, Ukraine. We make no representation that materials
              at this site are appropriate or available for use at other
              locations outside of the Ukraine and access to them from
              ...
              <br></br>
              <br></br>
              12. GENERAL A. If any provision of these Terms and Conditions is
          ...
          <div className="flex flex-col md:flex-row w-full items-center gap-4 justify-between">
            ...
            <div className=" flex items-center gap-3">
              ...
              <DialogClose
                className={`flex items-center gap-2 px-3 py-2 bg-primary-red text-white font-semibold rounded-md ${
                  !isChecked && "bg-primary-red/50 "
                }`}
              >
                <p>Accept</p>
                <Check size={20} />
